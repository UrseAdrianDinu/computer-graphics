...
Mesh* Object3D::CreateCube(const char* name, float length, glm::vec3 color, std::unordered_map<std::string, Mesh*>& meshes)
{
...
Mesh* Object3D::CreatePara(const char* name, float length, float width, float height,
    ...
    std::unordered_map<std::string, Mesh*>& meshes)
{
    ...
    std::vector<VertexFormat> vertices =
    {
        VertexFormat(corner, glm::vec3(0), glm::vec3(0, 1, 0), glm::vec2(0, 0)),
        VertexFormat(corner + glm::vec3(length, 0, 0), glm::vec3(0), glm::vec3(0, 1, 0), glm::vec2(1, 0)),
        VertexFormat(corner + glm::vec3(length, 0, length), glm::vec3(0), glm::vec3(0, 1, 0),glm::vec2(1, 1)),
        VertexFormat(corner + glm::vec3(0, 0, length), glm::vec3(0), glm::vec3(0,1,0), glm::vec2(0, 1)),
    };
...
Mesh* Object3D::CreateCone(const char* name, float radius, glm::vec3 color, std::unordered_map<std::string, Mesh*>& meshes)
{
    ...
    for (unsigned int i = 0; i <= 25; i++) {
            ...
            vertices.emplace_back(glm::vec3(cos(arg) * radius, -1, sin(arg) * radius), color);
            indices.push_back(i);
    }

    Mesh* cone = CreateMesh(name, vertices,indices,meshes);
    cone->SetDrawMode(GL_TRIANGLE_FAN);
    return cone;
}


Mesh* Object3D::CreateMesh(const char* name,
