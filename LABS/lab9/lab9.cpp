...
void Lab9::Update(float deltaTimeSeconds)
{
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, mapTextures["crate"], mapTextures["bamboo"]);
    }
    ...
    float angularstep = atan2(GetSceneCamera()->m_transform->GetLocalPosition().x, GetSceneCamera()->m_transform->GetLocalPosition().z);
    {
        glm::mat4 modelMatrix = glm::mat4(1);
