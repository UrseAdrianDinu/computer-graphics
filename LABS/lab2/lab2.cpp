...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(10, 0, 5), glm::vec3(0, 255, 0)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(15,  0,  5), glm::vec3(0, 255, 0)),
            VertexFormat(glm::vec3(10,  5,  5), glm::vec3(255, 0, 0)),
            VertexFormat(glm::vec3(15,  5,  5), glm::vec3(255, 0, 0)),
            VertexFormat(glm::vec3(10, 0, 0), glm::vec3(0, 255, 0)),
            VertexFormat(glm::vec3(15,  0,  0), glm::vec3(0, 255, 0)),
            VertexFormat(glm::vec3(10 , 5,  0), glm::vec3(0, 0, 255)),
            VertexFormat(glm::vec3(15,  5,  0), glm::vec3(255, 0, 0)),
        };
    ...
    
    {
        ...
        {
            VertexFormat(glm::vec3(1,  0,  0), glm::vec3(255, 0, 0)),
            VertexFormat(glm::vec3(2,  0,  0), glm::vec3(0, 255, 0)),
            VertexFormat(glm::vec3(1.5f,  0,  1), glm::vec3(0, 0, 255)),
            VertexFormat(glm::vec3(1.5f, 0.81f,  0.33f), glm::vec3(255, 0, 0)),
        };
        ...
        CreateMesh("tetrahedron", vertices_tetrahedron, indices_tetrahedron);
    }
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices_square
        {
            ...
            VertexFormat(glm::vec3(1,  0,  0), glm::vec3(0, 255, 0)),
            VertexFormat(glm::vec3(1,  1,  0), glm::vec3(0, 0, 255)),
...

    {
        ...
        vector<unsigned int> indices;
        GLfloat arg;
        vertices.emplace_back(glm::vec3(0, 2, 0), glm::vec3(255, 0, 0));
        for (unsigned int i = 0; i <= 25; i++) {
            arg = 2.0f * 3.14159f * i / 24;
            vertices.emplace_back(glm::vec3(cos(arg) , 0, sin(arg)), glm::vec3(255, 0, 0));
            indices.push_back(i);
        }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2.0f, 1.0f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-4.0f, 1, -1.5f)); 

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-2.0f, 1.0f, 1.0f));

    RenderMesh(meshes["cone"], shaders["VertexColor"], glm::vec3(5, 1.0f, 5.0f));
    ...
    //BONUS circle
    {
        ...
        vertices_circle.emplace_back(glm::vec3(0, 0, 0), glm::vec3(1.f, 1.f, 1.f));
        for (unsigned int i = 0; i <= N + 1; i++) {
            arg = 2.0f * 3.14159f * i / N;
            vertices_circle.emplace_back(glm::vec3(cos(arg), sin(arg), 0), glm::vec3(1, 1, 0));
    ...
    RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(4.0f, 0.5f, 3), glm::vec3(0.55f));
...
void Lab2::OnKeyPress(int key, int mods)
{
    ...
    // BONUS increase/decrease number of triangles
    if (key == GLFW_KEY_F2)
    {
        if (key == GLFW_KEY_F2) {
